...
been removed in favor of lighter functions.
...
* Remove pyrt.aerosol.TabularLegendreCoefficients and
  pyrt.aerosol.HenyeyGreenstein phase function classes. The functionality of
  these objects are moved into functions below.
* Make phase function utilities: resample, normalize, decompose,
  fit_asymmetry_parameter, construct_hg, decompose_hg,
  set_negative_coefficients_to_0, and reconstruct.
...
* Remove the spacecraft retrieval example.
* Add an "examples" section using notebook formats instead of code blocks.
* Add a phase function section. This includes a decomposition and H-G fit
  example.
* Add a retrievals section. This includes a sky image example.
